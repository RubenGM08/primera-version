package Unidad7.Actividad7_12R.Clases;
...
public class Lista {
    ...
    //Metodo para concatenar dos arrays

    //1. Para concatenar dos listas vamos a crear una tecera lista donde se guarda
    //las dos listas...
    public Lista concatenarLsta(Lista l1, Lista l2){
        ...
        System.out.println("El resultado de concatenar la lista 1 con la lista 2 es" + Arrays.toString(nuevaLista.elemento));
        return nuevaLista;
    }
