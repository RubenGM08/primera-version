...
public class Actividad2_14_ {
    public static void main(String[] args) {

        //Decalaramos el Escaner
        Scanner sc = new Scanner(System.in);

        //Inicializamos la variable entera
        int numero, num;

        System.out.print("Escribe un numero entero desde el 1 al 99= ");
        numero= sc.nextInt();
        System.out.println("");
        ...
        switch (numero){
            ...
            case 20:
                ...
                break;
            case 21:
                System.out.println("Ventiuno");
                break;
            case 22:
                System.out.println("Ventidos");
                break;
            case 23:
                System.out.println("Ventitres");
                break;
            case 24:
                System.out.println("Venticuatro");
                break;
            case 25:
                System.out.println("Venticinco");
                break;
            case 26:
                System.out.println("Ventiseis");
                break;
            case 27:
                System.out.println("Ventisiete");
                break;
            case 28:
                System.out.println("Ventiocho");
                break;
            case 29:
                System.out.println("Ventinueve");
                break;
            case 30:
            ...
            default:
                System.out.println("Tiene que ser un numero entre el 1 al 99");
        ...
        /*
        * 1-> Switch Numeros especiales: once, doce, trece, catorce, quince, dieciseis, diecisiete, ....veintinueve
        * 2-> Calcular las decenas int u= num% 10    d=num/10  ->switch con las decenas  -> diez, veinte ..... noventa
        * 3->Si u!=0   creamos una condicion que a concatenar con "y"
        * 4-> switch de unidades del 1 al 9
        *
         */

        /*2 -> logica,.... hacer un switch del 1 al 99, escribiendo todos los posibles resultados....
         * */
        ...
        switch (num){
            ...
            default->{
                ...
                //Luego si la decna es mayor o igaul a 3 y la unidad es distinta a 0
                if (d >= 3 && u!= 0){
                    salida+=  " y ";
                    switch (u){
                        case 1-> salida += "uno";
